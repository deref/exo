...
var childVariables = {
  'log-color': [ 'var(--light-log-color)', 'var(--dark-log-color)', 'var(--dark-log-color)'],
  'log-bg-color': [ 'var(--light-log-bg-color)', 'var(--dark-log-bg-color)', 'var(--dark-log-bg-color)'],
  'log-hover-color': [ 'var(--light-log-hover-color)', 'var(--dark-log-hover-color)', 'var(--dark-log-hover-color)'],
  'log-bg-hover-color': [ 'var(--light-log-bg-hover-color)', 'var(--dark-log-bg-hover-color)', 'var(--dark-log-bg-hover-color)'],
};
