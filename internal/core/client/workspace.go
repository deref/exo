...
func (c *Workspace) DescribeApiGateways(ctx context.Context, input *api.DescribeApiGatewaysInput) (output *api.DescribeApiGatewaysOutput, err error) {
	err = c.client.Invoke(ctx, "describe-api-gateways", input, &output)
	return
}
